...
public class NcdcRecordDto  implements Writable {
    ...
    public String toString() {
        return "NcdcRecordDto{" +
                ...
                ", day='" + day + '\'' +
                ", meanTemp=" + meanTemp +
                ", meanTempCount=" + meanTempCount +
                ", meanDewPointTemp=" + meanDewPointTemp +
                ", meanDewPointTempCount=" + meanDewPointTempCount +
                ", meanSeaLevelPressure=" + meanSeaLevelPressure +
                ", meanSeaLevelPressureCount=" + meanSeaLevelPressureCount +
                ", meanStationPressure=" + meanStationPressure +
                ", meanStationPressureCount=" + meanStationPressureCount +
                ", meanVisibility=" + meanVisibility +
                ", meanVisibilityCount=" + meanVisibilityCount +
                ", meanWindSpeed=" + meanWindSpeed +
                ", meanWindSpeedCount=" + meanWindSpeedCount +
                ", maxSustainedWindSpeed=" + maxSustainedWindSpeed +
                ", maxGustWindSpeed=" + maxGustWindSpeed +
                ", maxTemp=" + maxTemp +
                ", maxTempFlag='" + maxTempFlag + '\'' +
                ", minTemp=" + minTemp +
                ", minTempFlag='" + minTempFlag + '\'' +
                ", totalPrecipitation=" + totalPrecipitation +
                ", totalPrecipitationFlag='" + totalPrecipitationFlag + '\'' +
                ", snowDepth=" + snowDepth +
                ", hasFog=" + hasFog +
                ", hasRain=" + hasRain +
                ", hasSnow=" + hasSnow +
